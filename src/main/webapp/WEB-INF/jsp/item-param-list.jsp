...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'item/param/list',method:'post',pageSize:10,toolbar:itemParamListToolbar">
    <thead>
        <tr>
